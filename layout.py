                        ...
                        html.Div(
                            [
                                ...
                                dbc.Button("New Viz 4", id={"type": "visualization-btn", "index": "viz4"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 5", id={"type": "visualization-btn", "index": "viz5"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 6", id={"type": "visualization-btn", "index": "viz6"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 7", id={"type": "visualization-btn", "index": "viz7"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 8", id={"type": "visualization-btn", "index": "viz8"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 9", id={"type": "visualization-btn", "index": "viz9"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 10", id={"type": "visualization-btn", "index": "viz10"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 11", id={"type": "visualization-btn", "index": "viz11"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 12", id={"type": "visualization-btn", "index": "viz12"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 13", id={"type": "visualization-btn", "index": "viz13"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 14", id={"type": "visualization-btn", "index": "viz14"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 15", id={"type": "visualization-btn", "index": "viz15"},
                                           className="mb-1 w-100"),
                                dbc.Button("New Viz 16", id={"type": "visualization-btn", "index": "viz16"},
                                           className="mb-1 w-100"),
                            ],
                            style={
